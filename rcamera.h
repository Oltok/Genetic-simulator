...
#ifndef RCAMERA_H
#define RCAMERA_H
#define RCAMERA_IMPLEMENTATION  //CAMBIO MIO
//----------------------------------------------------------------------------------
// Defines and Macros
//----------------------------------------------------------------------------------
...
#else
    #define CAMERA_CULL_DISTANCE_NEAR   0.05 //RL_CULL_DISTANCE_NEAR    CAMBIO MIO
    #define CAMERA_CULL_DISTANCE_FAR    4000.0 //RL_CULL_DISTANCE_FAR   CAMBIO MIO
#endif
...
// Defines and Macros
//----------------------------------------------------------------------------------
#define CAMERA_MOVE_SPEED                           200.0f       // Units per second     CAMBIO MIO
